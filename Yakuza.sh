...
while [[ $MENU_PRINCIPAL -ne 4 ]]
do
   clear
   echo '
^-------------------------------------/\--.
||============================= \\\\\\  \/~\/\
||     EQUIPE: Speatec Wayne     \\\\\\  \/
...
Caso você esteja em dúvida de como usar a script é só escolher a opção que deseja no menu principal e ler com atenção o passo a passo !\033[0m'
     ...
     2)
      #Parte que envia audio de homem
         ...
         PEGARÁ NO WHATSAPP. \033[0m'
            ...
            sleep 6;echo "$VOZ_DE_HOMEM" | espeak -vbrazil-mbrola-1 -s 120 -k 20 -p 5
            clear
            DESENHO_HELE
            echo -e '
 ...
 \033[1;31m         DIGITE ALGUMA COISA PRO TERMUX FALAR:  \033[0m'
         ...
         PEGARÁ NO WHATSAPP. \033[0m'
            ...
            termux-open https://play.google.com/store/apps/details?id=com.whatsapp
            #comando de fazer o termux falar
            sleep 6;echo "$VOZ_DE_MULHER" | espeak -vbrazil-mbrola-4 -s 130 -p 60
            clear
            DESENHO_HELE
            echo -e '\033[1;33m
     ...
     4) 
      #Opção de sair, aqui tbm aparece os creditos
          ...
          sleep 0.5
          echo -e '\033[1;34m     Gabriel Wayne\033[0m'
          sleep 0.5
          ...
          sleep 0.5
          echo -e '\033[1;34m     HELLSING.\033[0m'
          sleep 0.5
          echo -e '\033[1;32mSCRIPT DA EQUIPE:\033[0m'
          sleep 0.5
          echo -e '\033[1;34m     Speatec Wayne.\033[0m'
          sleep 0.5
